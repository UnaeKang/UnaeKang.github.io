...
date: 2024-07-13 22:45:17 +09:00
tags : [crud, til]
---
`1. src/main/webapp에 views 폴더 추가`<br>
`2. src/main/webapp/views에 book.jsp 파일 생성`<br>
→ 사용자에게 보여줄 화면 구성 [book.jsp]
...
<body>
	...
	<div class="guestbook list" style="display: block;">
		<%if(list != null && list.isEmpty()==false){%raw%}{
